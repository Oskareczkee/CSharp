...
namespace SQL_Server_DB {
    ...
    public partial class EmployeeDataSet : global::System.Data.DataSet {
        ...
        public partial class EmployeeDataTable : global::System.Data.TypedTableBase<EmployeeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public EmployeeRow AddEmployeeRow(int EmployeeID, string Name, string Surname, string Position, int Hourly_Rate) {
            ...
            private void InitClass() {
                ...
                this.columnHourly_Rate = new global::System.Data.DataColumn("Hourly Rate", typeof(int), null, global::System.Data.MappingType.Element);
        ...
        public partial class EmployeeRow : global::System.Data.DataRow {
            ...
            public int Hourly_Rate {
                get {
                    return ((int)(this[this.tableEmployee.Hourly_RateColumn]));
                }
                set {
                    this[this.tableEmployee.Hourly_RateColumn] = value;
                }
            }
        }
...
namespace SQL_Server_DB.EmployeeDataSetTableAdapters {
    ...
    public partial class EmployeeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Employee] WHERE (([EmployeeID] = @Original_EmployeeID) AND ([N" +
                "ame] = @Original_Name) AND ([Surname] = @Original_Surname) AND ([Position] = @Or" +
                "iginal_Position) AND ([Hourly Rate] = @Original_Hourly_Rate))";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Hourly_Rate", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Hourly Rate", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Employee] ([EmployeeID], [Name], [Surname], [Position], [Hourly Rate]) VALUES (@EmployeeID, @Name, @Surname, @Position, @Hourly_Rate);
SELECT EmployeeID, Name, Surname, Position, [Hourly Rate] FROM Employee WHERE (EmployeeID = @EmployeeID)";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Hourly_Rate", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Hourly Rate", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Employee] SET [EmployeeID] = @EmployeeID, [Name] = @Name, [Surname] = @Surname, [Position] = @Position, [Hourly Rate] = @Hourly_Rate WHERE (([EmployeeID] = @Original_EmployeeID) AND ([Name] = @Original_Name) AND ([Surname] = @Original_Surname) AND ([Position] = @Original_Position) AND ([Hourly Rate] = @Original_Hourly_Rate));
SELECT EmployeeID, Name, Surname, Position, [Hourly Rate] FROM Employee WHERE (EmployeeID = @EmployeeID)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Hourly_Rate", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Hourly Rate", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Hourly_Rate", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Hourly Rate", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        }
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::SQL_Server_DB.Properties.Settings.Default.EmployeeConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT EmployeeID, Name, Surname, Position, [Hourly Rate] FROM dbo.Employee";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT EmployeeID, Name, Surname, Position, [Hourly Rate] FROM dbo.Employee ORDER" +
                " BY [Hourly Rate]";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "SELECT EmployeeID, Name, Surname, Position, [Hourly Rate] FROM dbo.Employee ORDER" +
                " BY [Hourly Rate] Desc";
            this._commandCollection[2].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[3] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[3].Connection = this.Connection;
            this._commandCollection[3].CommandText = "SELECT EmployeeID, Name, Surname, Position, [Hourly Rate] FROM dbo.Employee WHERE" +
                " Name LIKE \'%\'+ @name +\'%\' OR Surname LIKE \'%\'+@name+\'%\'";
            ...
            this._commandCollection[4].CommandText = "SELECT Max([Hourly Rate]) FROM Employee";
            this._commandCollection[4].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[5] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[5].Connection = this.Connection;
            this._commandCollection[5].CommandText = "SELECT Min([Hourly Rate]) FROM Employee";
        ...
        public virtual int FillByHourlyRateAsc(EmployeeDataSet.EmployeeDataTable dataTable) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillByHourlyRateDesc(EmployeeDataSet.EmployeeDataTable dataTable) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FindByName(EmployeeDataSet.EmployeeDataTable dataTable, string name) {
        ...
        public virtual int Delete(int Original_EmployeeID, string Original_Name, string Original_Surname, string Original_Position, int Original_Hourly_Rate) {
            ...
            this.Adapter.DeleteCommand.Parameters[4].Value = ((int)(Original_Hourly_Rate));
        ...
        public virtual int Insert(int EmployeeID, string Name, string Surname, string Position, int Hourly_Rate) {
            ...
            this.Adapter.InsertCommand.Parameters[4].Value = ((int)(Hourly_Rate));
        ...
        public virtual int Update(int EmployeeID, string Name, string Surname, string Position, int Hourly_Rate, int Original_EmployeeID, string Original_Name, string Original_Surname, string Original_Position, int Original_Hourly_Rate) {
            ...
            this.Adapter.UpdateCommand.Parameters[4].Value = ((int)(Hourly_Rate));
            ...
            this.Adapter.UpdateCommand.Parameters[9].Value = ((int)(Original_Hourly_Rate));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Surname, string Position, int Hourly_Rate, int Original_EmployeeID, string Original_Name, string Original_Surname, string Original_Position, int Original_Hourly_Rate) {
            return this.Update(Original_EmployeeID, Name, Surname, Position, Hourly_Rate, Original_EmployeeID, Original_Name, Original_Surname, Original_Position, Original_Hourly_Rate);
        }
        
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual global::System.Nullable<int> FindMaxHourlyRate() {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual global::System.Nullable<int> FindMinHourlyRate() {
